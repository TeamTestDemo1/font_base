      ...
      <div style="width: 500px; height: 350px; background-color:rgba(9, 50, 113 ,0.2); border-radius: 10px;
        ...
        <div style="width: 260px; margin: 0 auto; padding-top: 30px">
          ...
          <div style="padding: 10px 0; text-align: right">
            <span style="cursor: pointer; color:black" @click="preReset">忘记密码</span>
            <span style="cursor: pointer; color:black; margin-left: 10px" @click="goRegister">去注册</span>
          </div>
        </div>
      </div>
    </div>
...
<style scoped>
.bgImg {
  background: url("../bg_login/微信图片_20220527154235.jpg") no-repeat;
