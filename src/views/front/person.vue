<template>
  <div style="margin-top: 10px">
            ...
            <el-col :span="12" :offset="10">
              ...
              <div style="padding: 10px 0; margin-top: 20px">
                ...
                <div style="padding: 10px 0; display: flex">
                  ...
                  <span style="flex: 5">{{ userInfo.nickName }}</span>
                </div>
                <div style="padding: 10px 0; display: flex">
                  <div style="flex: 1">学号：</div>
                  <div style="flex: 5">{{ userInfo.uid }}</div>
                </div>
                <div style="padding: 10px 0; display: flex">
                ...
                <div style="padding: 10px 0; display: flex">
                  ...
                  <div style="flex: 5">{{ userInfo.address }}</div>
                </div>
                <div style="padding: 10px 0; display: flex">
                  <div style="flex: 1">年龄：</div>
                  <div style="flex: 5">{{ userInfo.age }}</div>
                </div>
              </div>
    ...
    <el-dialog title="个人信息" v-model="dialogFormVisible"  width="30%"
