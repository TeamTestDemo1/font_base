...
<!--                                <el-button v-if="user.role[0] ===3" @click="load" type="primary" style="margin-left: 10px">查询</el-button>-->
        ...
        <el-table :data="tableData"  stripe style="width: 100%">
            ...
            <el-table-column prop="state" label="课程属性"></el-table-column>
            <el-table-column prop="type" label="课程性质"></el-table-column>
            <el-table-column prop="score" label="学分"></el-table-column>
            <el-table-column prop="className" label="班级名称"></el-table-column>
            <el-table-column prop="year" label="学期"></el-table-column>
            <el-table-column prop="computerTime" label="实际上机时间"></el-table-column>
            <el-table-column prop="computerpraticeBounce" label="工作量"></el-table-column>
            <el-table-column
                    prop="state"
                    label="状态">
            </el-table-column>
        ...
        <el-dialog title="信息" :visible.sync="dialogFormVisible" width="30%"
            ...
            <el-form :model="entity">
                ...
                <el-form-item label="课程属性" label-width="120px">
                    <el-input v-model="entity.state" autocomplete="off" style="width: 80%"></el-input>
                </el-form-item>
                <el-form-item label="课程性质" label-width="120px">
                ...
                <el-form-item label="实际上机时间" label-width="120px">
                    <el-input v-model="entity.computerTime" autocomplete="off" style="width: 80%"></el-input>
                </el-form-item>
                <el-form-item label="工作量" label-width="120px">
                    <el-input v-model="entity.computerpraticeBounce" autocomplete="off" style="width: 80%"></el-input>
                </el-form-item>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            exp() {   // excel 导出
                window.open("http://localhost:9999/computerpractice/export");
            },
            ...
            getcount(){
                ...
                {
                    this.request.get("http://localhost:9999/computerpractice/count").then(res=>{
                        console.log(res)
                ...
                {
                    this.request.get("http://localhost:9999/computerpractice/"+this.teacherName).then(res=>{
                        console.log(res)
                        this.totalwork = res.data
                    })
                }
            ...
            getData(){
                this.request.get("http://localhost:9999/computerpractice/page?pageNum=" + this.pageNum+ "&pageSize=" + this.pageSize + "&teacherName=" + this.teacherName + "&className=" + this.className).then(res=>{
            ...
            load() {
                this.request.get("http://localhost:9999/computerpractice/page", {
                    params: {
            ...
            save() {
                if (!this.entity.id) {
                    this.request.post("http://localhost:9999/computerpractice", this.entity).then(res => {
                        if (res.code === '0') {
                            this.$message({
                                type: "success",
                                message: "操作成功"
                    ...
                    this.request.put("http://localhost:9999/computerpractice", this.entity).then(res => {
                        if (res.code === '0') {
                            this.$message({
                                type: "success",
                                message: "操作成功"
            ...
            del(id) {
                this.request.delete("http://localhost:9999/computerpractice/" + id).then(res => {
                    this.$message({
                        type: "success",
                        message: "操作成功"
                    })
            ...
            hSubmitChkState(){
                ...
                if(this.state1 === '通过'){
                    this.computer.checkstate = "审核通过"
                }else if(this.state1 === '拒绝'){
                    this.computer.checkstate = this.remark
                }
                this.request.put("http://localhost:9999/computerpractice",this.computer).then(res=>{
                    console.log(res)
                })
                this.getData()
