...
let routes = [
    ...
    //     component: () => import("../views/manage/lilun.vue")
    // },
    // {
    //     path: 'paper',
    //     name: 'Paper',
    //     component: () => import("../views/pingsheng/paper.vue")
    // },
    // {
    //     path: 'project',
    //     name: 'Project',
    //     component: () => import("../views/pingsheng/project")
    // },
    // {
    //     path: 'stuNumber',
    //     name: 'StuNumber',
    //     component: () => import("../views/pingsheng/stuNumber")
    // },
...
// const permissionCheck = sessionStorage.getItem("permission")
// if (permissionCheck) {
//     resetRouterCheck(JSON.parse(permissionCheck))
// }
...
// export function resetRouterCheck(permissions) {
//     if (permissions) {
//         const newRouter = createRouter()
//         router.matcher = newRouter.matcher // 新路由实例matcer，赋值给旧路由实例的matcher，（相当于replaceRouter）
//         if (!router.getRoutes().find(v => v.name === 'Manage')) {
//             router.addRoute(getPermissionsCheck(permissions))
//         }
//     }
//
// }
// function getPermissionsCheck(permissions) {
//     let check = {
//         path: '/check', name: 'Check', component: () => import("../layout/manage"),
//         // children: [
//         //     {path: 'person', name: '个人信息', component: () => import("../views/manage/person")}
//         // ]
//     }
...
//         permissions.forEach(item => {
//             check.children.push({
//                 path: "/check" + item.path,
//                 name: item.name,
//                 component: () => import("../views/pingsheng" + item.path)
//             });
//         })
//     }
//
